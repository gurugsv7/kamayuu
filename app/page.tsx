...
export default function Home(){
 ...
 <div className="account-block">
  ...
  <button className="text-action" onClick={()=>setPanel('credits')}>Credits</button>
